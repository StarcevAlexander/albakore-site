...
export class LeasingPage {
  ...
  steps = [
    { num: '01', title: 'Выберите модель', desc: 'Подберите катер из каталога или обратитесь к менеджеру для подбора под ваши задачи.' },
    ...
    { num: '04', title: 'Получение', desc: 'Подписание договора и передача катера. Регистрация в ГИМС по желанию включена в сервис.' },
  ];
}
