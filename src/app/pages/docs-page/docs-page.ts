...
export class DocsPage {
  constructor() {
    inject(MetaService).set({
      ...
      description:
        'Технические паспорта, инструкции по эксплуатации и сертификаты на измельчители древесины Промсервис. Скачайте документацию онлайн.',
  ...
  public readonly docs: DocItem[] = [
    {
      title: 'Каталог измельчителей древесины Моби',
      desc: 'Полный каталог продукции — модельный ряд измельчителей древесины Моби с техническими характеристиками.',
      type: 'Каталог продукции',
      file: '/docs/katalog-mobi.pdf',
    },
    {
